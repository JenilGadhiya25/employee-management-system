...
const Dashboard = () => {
  ...
  const pieData = [
    ...
    { name: 'Pending', value: (stats?.totalTasks || 0) - (stats?.completedTasks || 0),  },
  ]
  ...
  return (
    <div style={{ maxWidth: 1400, padding: '0 20px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20, marginBottom: 28 }}>
        {[
          { label: 'Total Employees', value: stats?.totalEmployees || 0, trend: '+18%' },
          { label: 'Present Today', value: stats?.presentToday || 0, trend: '+11%' },
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid #E2E8F0' }}>
                  <th style={{ textAlign: 'left', padding: '12px 0', fontSize: 12, fontWeight: 600, color: '#64748B' }}>Destination</th>
                  <th style={{ textAlign: 'left', padding: '12px 0', fontSize: 12, fontWeight: 600, color: '#64748B' }}>Date</th>
                  <th style={{ textAlign: 'left', padding: '12px 0', fontSize: 12, fontWeight: 600, color: '#64748B' }}>People</th>
                </tr>
              </thead>
              <tbody>
          ...
          <div style={{
            ...
            <div style={{ marginTop: 20, paddingTop: 20, borderTop: '1px solid #E2E8F0' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {[
                  { id: '03KFD7', name: 'John Doe', amount: '$349' },
                  { id: '03KFD7', name: 'Alex K', amount: '$349', highlight: true },
                ].map((item, idx) => (
                  <div key={idx} style={{
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 10, color: item.highlight ? 'rgba(255,255,255,0.7)' : '#64748B', marginTop: 2 }}>
                        {item.name}
                      </div>
                    </div>
